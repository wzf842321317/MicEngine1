...
<div class="container col-12 border rounded">	<!-----------数据区域------------------->
	...
	<div class="container col-12 border rounded">
		<div class="row border rounded" id="CheckSiteMsg" style="margin:3px"></div><!-->配置信息<-->
		<div class='col-sm-12' id='PageEcharts' style='height: 400px;width:100%;display: ;border: 1px solid #cecece;'></div>
		<div class="row border rounded" id="CfgMsg" style="margin:3px"></div><!-->配置信息<-->
		<div class="row border rounded" id="TongJi" style="margin:3px;display: "></div><!-->配置信息<-->
